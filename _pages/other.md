...
* Survey input：
  *	Remark Office OCR, EPIdata, Qualtrics
* Database：
  *	MS ACCESS, MySQL 5.6
* Website Design：
  *	Adobe Dreamweaver, Adobe Photoshop, Adobe Illustrator, Adobe After Effects
  *	WordPress, Jekyll
* Office and editing software：
  *	Office (MS Office, MS Publisher), R Markdown (Markdown), LaTeX
* Programming：
  *	C & C++ (NCRE 2)
...
======
  ...
  * Statement of Accomplishment with distinction in Structural Equation Model and its Applications, Chinese University of Hong Kong, 
  * Coursera
